...
public class GreetingAop {
    ...
    @Before("execution(* com.seteven.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @After("execution(* com.seteven.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @AfterReturning("execution(* com.seteven.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @AfterThrowing("execution(* com.seteven.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @Around("execution(* com.seteven.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
